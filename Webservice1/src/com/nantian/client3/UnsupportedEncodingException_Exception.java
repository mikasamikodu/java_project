 ...
 * 
 */
@WebFault(name = "UnsupportedEncodingException", targetNamespace = "http://service.interf.gtjt.cux/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.nantian.client3.UnsupportedEncodingException
     */

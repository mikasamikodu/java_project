 ...
 <div class="navbar-wrapper">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active" onclick="window.location.href='project.htm'" style="cursor:pointer;">
          <img src="img/carousel-1.jpg" alt="First slide">
        </div>
        <div class="item" onclick="window.location.href='project.htm'" style="cursor:pointer;">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3 class="break">
								<a href="project.htm">活性富氢净水直饮机</a>
							</h3>
                            <p>
				...
				<div class="col-md-3">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3 class="break">
								<a href="project.htm">酷驰触控龙头，智享厨房黑科技</a>
							</h3>
                            <p>
                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
				...
				<div class="col-md-3">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3 class="break">
								<a href="project.htm">小熊猫鱼眼全景安防摄像机</a>
							</h3>
                            <p>
                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>

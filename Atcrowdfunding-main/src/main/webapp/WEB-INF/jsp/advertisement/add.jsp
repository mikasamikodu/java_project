			  ...
			  <div class="panel-body">
				<form id="addForm" enctype="multipart/form-data" method="post">
				  <div class="form-group">
					...
					<input type="text" class="form-control" name="name" id="fname" placeholder="请输入广告名称">
				  </div>
				  <div class="form-group">
					<label for="furl">广告链接</label>
					<input type="text" class="form-control" id="furl" name="url" placeholder="请输入广告链接">
				  </div>
				  <div class="form-group">
					<label for="fadvpicc">广告图片</label>
					<input type="file" class="form-control" id="fadvpic" name="advpic" placeholder="请选择广告图片">
				  </div>

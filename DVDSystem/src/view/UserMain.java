...
public class UserMain extends JFrame {
	...
	private void init() {
		...
		jb_rent=new JButton("查看租赁DVD相关操作");
		jb_record=new JButton("查看租赁DVD相关记录");
	...
	private void Register() {
		...
		jb_record.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				DVDReturn return1=new DVDReturn(user);
				jd_center.add(return1);
				return1.toFront();
			}
		});
	}

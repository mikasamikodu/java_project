 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://soap2.nantian.com/", wsdlLocation = "http://localhost:9999/server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://soap2.nantian.com/", "MyServiceImplService");
    ...
    public MyService getMyServiceImplPort() {
        return super.getPort(new QName("http://soap2.nantian.com/", "MyServiceImplPort"), MyService.class);
    }
    ...
    public MyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap2.nantian.com/", "MyServiceImplPort"), MyService.class, features);
    }

 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://www.example.org/mywsdl/", wsdlLocation = "http://localhost:9999/service?wsdl")
    ...
    extends Service
{
    ...
    public MyService getMyServiceImplPort() {
        return super.getPort(new QName("http://www.example.org/mywsdl/", "MyServiceImplPort"), MyService.class);
    }
    ...
    public MyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.example.org/mywsdl/", "MyServiceImplPort"), MyService.class, features);
    }
